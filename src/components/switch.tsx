...
const colors = {
  ...
  yellow: [
    "[--switch-bg-ring:var(--color-yellow-600)]/90 [--switch-bg:var(--color-yellow-500)] dark:[--switch-bg-ring:transparent]",
    "[--switch:white] [--switch-ring:var(--color-yellow-600)]/90 [--switch-shadow:var(--color-yellow-900)]/20",
  ],
  fuchsia: [
